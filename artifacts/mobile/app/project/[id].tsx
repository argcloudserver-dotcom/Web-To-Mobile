  ...
  return (
    <View style={s.container}>
      <View style={[s.header, { backgroundColor: c.card, borderBottomColor: c.border }]}>
        ...
        <View style={[s.statusBadge, { backgroundColor: project.isActive ? `${c.success}18` : `${c.mutedForeground}18` }]}>
          <Text style={[s.statusTxt, { color: project.isActive ? c.success : c.mutedForeground }]}>
