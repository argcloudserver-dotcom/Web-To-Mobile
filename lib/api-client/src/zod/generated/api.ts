...
export const ListLeadsResponseItem = zod.object({
  ...
  "status": zod.enum(['new', 'called', 'qualified', 'meeting', 'negotiation', 'bought', 'not_qualified', 'low_budget']),
...
export const CreateLeadBody = zod.object({
  ...
  "status": zod.enum(['new', 'called', 'qualified', 'meeting', 'negotiation', 'bought', 'not_qualified', 'low_budget']).optional(),
  "projectId": zod.string().nullish(),
  "notes": zod.string().nullish(),
  "deadline": zod.string().nullish()
})
