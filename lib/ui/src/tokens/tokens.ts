...
export const crmStatus = {
  ...
  meeting:       { bg: '#F59E0B', muted: '#FFFBEB', text: '#D97706', label: 'Meeting' },
  negotiation:   { bg: '#F97316', muted: '#FFF7ED', text: '#EA580C', label: 'Negotiation' },
  bought:        { bg: '#22C55E', muted: '#F0FDF4', text: '#16A34A', label: 'Bought' },
  not_qualified: { bg: '#EF4444', muted: '#FEF2F2', text: '#DC2626', label: 'Not Qualified' },
  low_budget:    { bg: '#F43F5E', muted: '#FFF1F2', text: '#E11D48', label: 'Low Budget' },
} as const;
